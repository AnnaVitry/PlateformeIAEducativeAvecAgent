...
class AiClient
{
    ...
    public function sendMessage(string $message, array $options = []): array
    {
        ...
        curl_setopt($ch, CURLOPT_TIMEOUT, 20); // max seconds for the whole request

        // Optionnel : vérification TLS système (par défaut activé)
        ...
        if ($httpCode < 200 || $httpCode >= 300) {
            // essayer de décoder le body pour renvoyer une erreur utile
